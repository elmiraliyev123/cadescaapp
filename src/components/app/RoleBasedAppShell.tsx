  ...
  return (
    <RouteGuard role={role}>
      <div className="min-h-dvh bg-background text-on-background">
        ...
        <AppTopBar />
        <main className={cn("mx-auto min-h-dvh max-w-[1280px] px-4 pt-[calc(104px+env(safe-area-inset-top))] md:ml-[260px] md:px-7 md:py-7 lg:px-9", hasBottomNav ? "pb-[calc(96px+env(safe-area-inset-bottom))]" : "pb-8", "md:pb-8")}>
          {children}
        </main>
